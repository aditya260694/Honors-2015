...
from cdecl import _explain_type,explain_c_declaration,recurse_type
...
'''
text = r"""static char func1(unsigned int a, struct foo *b)
{
	int c = 0;
	struct bar *d;
	if (a == 0) {
...
#	if type(i) == c_ast.Typedef:
#		print('%s' % (_explain_type(i.type)))	
...
#
#for_stmt = function_body.block_items[3]
#~ for_stmt.show()
